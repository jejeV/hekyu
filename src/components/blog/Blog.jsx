      ...
      <div className="blog__container grid">
        <div className="blog__card">
          <div className="blog__thumb">
            <a href="#helo"><span className="blog__category">Reviews</span></a>
            <a href="#helo"><img src={Image1} alt="" className='blog__img' /></a> 
          </div>
        ...
        <div className="blog__card">
          <div className="blog__thumb">
            <a href="#helo"><span className="blog__category">Tutorial</span></a>
            <a href="#helo"><img src={Image2} alt="" className='blog__img' /></a> 
          </div>
          <div className="blog__details">
        ...
        <div className="blog__card">
          <div className="blog__thumb">
            <a href="#helo"><span className="blog__category">Business</span></a>
            <a href="#helo"><img src={Image1} alt="" className='blog__img' /></a> 
          </div>
          <div className="blog__details">
